...
namespace testJsonAPI
{
    public static class Define
    {
        ...
        public static Dictionary<string, string> idolName = new Dictionary<string, string>();
        public static Dictionary<string, string> idolType = new Dictionary<string, string>();
